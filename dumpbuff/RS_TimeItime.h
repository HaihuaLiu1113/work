...
public:
	...
	RSTimeItime(int timeId, int sec, TimeHandler callback, int reapteTimes_, ioPtr_t time);
	~RSTimeItime();
	static ptr_t create(int timeId, int sec, TimeHandler callback, int reapteTimes_, ioPtr_t time);
